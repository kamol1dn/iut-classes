...
| Mid-term | Final | Attendance | Assignments | Quiz | Etc. (term project) |
|---|---|---|---|---|---|
| 25% | 25% | 10% | 20% | 0% | **20%** |

Exams are only 50% here — the lowest of any course this semester. The **term
project (20%, presented week 14)** and assignments (20%) carry the rest, and
attendance is weighted double the other courses at 10%.

## Materials on hand

**Week 1**
- [1.1. Intro to AI](lectures/week01%20-%201.1.%20Intro%20to%20AI.pdf)
- [1.2. Intro to Machine Learning](lectures/week01%20-%201.2.%20Intro%20to%20Machine%20Learning.pdf)

**Week 2**
- [2.1. Intro to Machine Learning](lectures/week02%20-%202.1.%20Intro%20to%20Machine%20Learning.pdf)
- [2.2. Logistic Regression](lectures/week02%20-%202.2.%20Logistic%20Regression.pdf)
